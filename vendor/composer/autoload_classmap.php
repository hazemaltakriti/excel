...
return array(
    ...
    'controller\\admin' => $baseDir . '/controller/admin.php',
    'controller\\login' => $baseDir . '/controller/login.php',
    'controller\\middleware' => $baseDir . '/controller/middleware.php',
    'controller\\pagenotfound' => $baseDir . '/controller/pagenotfound.php',
    'controller\\signup' => $baseDir . '/controller/signup.php',
    'controller\\test' => $baseDir . '/controller/test.php',
    'controller\\testphp' => $baseDir . '/controller/testphp.php',
    'controller\\user' => $baseDir . '/controller/user.php',
    'lib\\Autoload' => $baseDir . '/lib/autoload.php',
    'lib\\Db' => $baseDir . '/lib/db.php',
    'lib\\Model' => $baseDir . '/lib/model.php',
    'lib\\assets' => $baseDir . '/lib/assets.php',
    'lib\\controller' => $baseDir . '/lib/controller.php',
    'lib\\file' => $baseDir . '/lib/file.php',
    'lib\\frontcontroller' => $baseDir . '/lib/frontcontroller.php',
    'lib\\interfaces\\Ijsondb' => $baseDir . '/lib/interfaces/ijsondb.php',
    'lib\\jsondb' => $baseDir . '/lib/jsondb.php',
    'lib\\jsonmodel' => $baseDir . '/lib/jsonmodel.php',
    'lib\\regex' => $baseDir . '/lib/regex.php',
    'lib\\request' => $baseDir . '/lib/request.php',
    'lib\\security' => $baseDir . '/lib/security.php',
    'lib\\session' => $baseDir . '/lib/session.php',
    'lib\\uploadedfile' => $baseDir . '/lib/uploadedfile.php',
    'mvc\\lib\\GlobalFunction' => $baseDir . '/lib/globalfunction.php',
    'tests\\valid\\vTest' => $baseDir . '/tests/valid/vTest.php',
    'tests\\valid\\validTest' => $baseDir . '/tests/valid/validTest.php',
    'validate\\v' => $baseDir . '/validate/v.php',
    'validate\\valid' => $baseDir . '/validate/valid.php',
);
