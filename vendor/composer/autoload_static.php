...
class ComposerStaticInitc1565f66d615cd0d5ca53dfeb4153008
{
    ...
    public static $classMap = array (
        ...
        'controller\\admin' => __DIR__ . '/../..' . '/controller/admin.php',
        'controller\\login' => __DIR__ . '/../..' . '/controller/login.php',
        'controller\\middleware' => __DIR__ . '/../..' . '/controller/middleware.php',
        'controller\\pagenotfound' => __DIR__ . '/../..' . '/controller/pagenotfound.php',
        'controller\\signup' => __DIR__ . '/../..' . '/controller/signup.php',
        'controller\\test' => __DIR__ . '/../..' . '/controller/test.php',
        'controller\\testphp' => __DIR__ . '/../..' . '/controller/testphp.php',
        'controller\\user' => __DIR__ . '/../..' . '/controller/user.php',
        'lib\\Autoload' => __DIR__ . '/../..' . '/lib/autoload.php',
        'lib\\Db' => __DIR__ . '/../..' . '/lib/db.php',
        'lib\\Model' => __DIR__ . '/../..' . '/lib/model.php',
        'lib\\assets' => __DIR__ . '/../..' . '/lib/assets.php',
        'lib\\controller' => __DIR__ . '/../..' . '/lib/controller.php',
        'lib\\file' => __DIR__ . '/../..' . '/lib/file.php',
        'lib\\frontcontroller' => __DIR__ . '/../..' . '/lib/frontcontroller.php',
        'lib\\interfaces\\Ijsondb' => __DIR__ . '/../..' . '/lib/interfaces/ijsondb.php',
        'lib\\jsondb' => __DIR__ . '/../..' . '/lib/jsondb.php',
        'lib\\jsonmodel' => __DIR__ . '/../..' . '/lib/jsonmodel.php',
        'lib\\regex' => __DIR__ . '/../..' . '/lib/regex.php',
        'lib\\request' => __DIR__ . '/../..' . '/lib/request.php',
        'lib\\security' => __DIR__ . '/../..' . '/lib/security.php',
        'lib\\session' => __DIR__ . '/../..' . '/lib/session.php',
        'lib\\uploadedfile' => __DIR__ . '/../..' . '/lib/uploadedfile.php',
        'mvc\\lib\\GlobalFunction' => __DIR__ . '/../..' . '/lib/globalfunction.php',
        'tests\\valid\\vTest' => __DIR__ . '/../..' . '/tests/valid/vTest.php',
        'tests\\valid\\validTest' => __DIR__ . '/../..' . '/tests/valid/validTest.php',
        'validate\\v' => __DIR__ . '/../..' . '/validate/v.php',
        'validate\\valid' => __DIR__ . '/../..' . '/validate/valid.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitc1565f66d615cd0d5ca53dfeb4153008::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitc1565f66d615cd0d5ca53dfeb4153008::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInitc1565f66d615cd0d5ca53dfeb4153008::$prefixesPsr0;
            $loader->classMap = ComposerStaticInitc1565f66d615cd0d5ca53dfeb4153008::$classMap;
